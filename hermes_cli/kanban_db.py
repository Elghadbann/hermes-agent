...
def claim_task(
    ...
    claimer: Optional[str] = None, authorization_required: bool = False,
) -> Optional[Task]:
    ...
    with write_txn(conn):
        if authorization_required:
            admitted, _reason = authorization_admission(conn, task_id)
            if not admitted:
                return None
...
from hermes_cli.kanban_db_authorization import (  # noqa: E402
